...
/*
**These code commented will cause bounds error
void generate_mine_map(int row, int col, char mine[row][col], int pos_row, int pos_col)
{
    col--;
    ...
    count += pos_row != row && pos_col && mine[pos_row + 1][pos_col - 1] == '*';
    count += pos_row && mine[pos_row - 1][pos_col] == '*';
    count += pos_row != row && mine[pos_row + 1][pos_col] == '*';
    count += pos_row && pos_col != col && mine[pos_row - 1][pos_col + 1] == '*';
    count += pos_col != col && mine[pos_row][pos_col + 1] == '*';
    count += pos_col != col && pos_row != row && mine[pos_row + 1][pos_col + 1] == '*';
